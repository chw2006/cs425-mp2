...
uint32_t Replica_numMachines_args::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t Replica_numMachines_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
...
uint32_t Replica_numMachines_result::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t Replica_numMachines_result::write(::apache::thrift::protocol::TProtocol* oprot) const {
...
uint32_t Replica_numMachines_presult::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t Replica_hasStateMachine_args::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t Replica_hasStateMachine_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  xfer += oprot->writeStructBegin("Replica_hasStateMachine_args");
...
uint32_t Replica_hasStateMachine_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  xfer += oprot->writeStructBegin("Replica_hasStateMachine_pargs");
...
uint32_t Replica_hasStateMachine_result::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t Replica_hasStateMachine_result::write(::apache::thrift::protocol::TProtocol* oprot) const {

  uint32_t xfer = 0;

  xfer += oprot->writeStructBegin("Replica_hasStateMachine_result");
...
uint32_t Replica_hasStateMachine_presult::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t Replica_replaceRM_args::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t Replica_replaceRM_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  xfer += oprot->writeStructBegin("Replica_replaceRM_args");
...
uint32_t Replica_replaceRM_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  xfer += oprot->writeStructBegin("Replica_replaceRM_pargs");
...
uint32_t Replica_replaceRM_result::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t Replica_replaceRM_result::write(::apache::thrift::protocol::TProtocol* oprot) const {

  uint32_t xfer = 0;

  xfer += oprot->writeStructBegin("Replica_replaceRM_result");
...
uint32_t Replica_replaceRM_presult::read(::apache::thrift::protocol::TProtocol* iprot) {
...
int32_t ReplicaClient::recv_numMachines()
{
  ...
  if (fname.compare("numMachines") != 0) {
    iprot_->skip(::apache::thrift::protocol::T_STRUCT);
    iprot_->readMessageEnd();
    iprot_->getTransport()->readEnd();
  }
  ...
  throw ::apache::thrift::TApplicationException(::apache::thrift::TApplicationException::MISSING_RESULT, "numMachines failed: unknown result");
}

bool ReplicaClient::hasStateMachine(const std::string& name)
{
  send_hasStateMachine(name);
  return recv_hasStateMachine();
}

void ReplicaClient::send_hasStateMachine(const std::string& name)
{
  int32_t cseqid = 0;
  oprot_->writeMessageBegin("hasStateMachine", ::apache::thrift::protocol::T_CALL, cseqid);

  Replica_hasStateMachine_pargs args;
  args.name = &name;
  args.write(oprot_);
...
bool ReplicaClient::recv_hasStateMachine()
{
  ...
  if (fname.compare("hasStateMachine") != 0) {
    iprot_->skip(::apache::thrift::protocol::T_STRUCT);
    iprot_->readMessageEnd();
    iprot_->getTransport()->readEnd();
  }
  bool _return;
  Replica_hasStateMachine_presult result;
  result.success = &_return;
  result.read(iprot_);
  iprot_->readMessageEnd();
  iprot_->getTransport()->readEnd();
  ...
  throw ::apache::thrift::TApplicationException(::apache::thrift::TApplicationException::MISSING_RESULT, "hasStateMachine failed: unknown result");
}

void ReplicaClient::replaceRM(const std::string& name)
{
  send_replaceRM(name);
  recv_replaceRM();
}

void ReplicaClient::send_replaceRM(const std::string& name)
{
  int32_t cseqid = 0;
  oprot_->writeMessageBegin("replaceRM", ::apache::thrift::protocol::T_CALL, cseqid);

  Replica_replaceRM_pargs args;
  args.name = &name;
  args.write(oprot_);
...
void ReplicaClient::recv_replaceRM()
{
  ...
  if (fname.compare("replaceRM") != 0) {
    iprot_->skip(::apache::thrift::protocol::T_STRUCT);
    iprot_->readMessageEnd();
    iprot_->getTransport()->readEnd();
  }
  Replica_replaceRM_presult result;
  result.read(iprot_);
  iprot_->readMessageEnd();
  iprot_->getTransport()->readEnd();
...
void ReplicaProcessor::process_numMachines(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
    ctx = this->eventHandler_->getContext("Replica.numMachines", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "Replica.numMachines");

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preRead(ctx, "Replica.numMachines");
  }

  Replica_numMachines_args args;
  args.read(iprot);
  iprot->readMessageEnd();
  uint32_t bytes = iprot->getTransport()->readEnd();

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postRead(ctx, "Replica.numMachines", bytes);
  }
  ...
  try {
    ...
    if (this->eventHandler_.get() != NULL) {
      this->eventHandler_->handlerError(ctx, "Replica.numMachines");
    }

    ::apache::thrift::TApplicationException x(e.what());
    oprot->writeMessageBegin("numMachines", ::apache::thrift::protocol::T_EXCEPTION, seqid);
    x.write(oprot);
    oprot->writeMessageEnd();
    oprot->getTransport()->writeEnd();
    oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preWrite(ctx, "Replica.numMachines");
  }

  oprot->writeMessageBegin("numMachines", ::apache::thrift::protocol::T_REPLY, seqid);
  result.write(oprot);
  oprot->writeMessageEnd();
  bytes = oprot->getTransport()->writeEnd();
  oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postWrite(ctx, "Replica.numMachines", bytes);
  }
}

void ReplicaProcessor::process_hasStateMachine(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
    ctx = this->eventHandler_->getContext("Replica.hasStateMachine", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "Replica.hasStateMachine");

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preRead(ctx, "Replica.hasStateMachine");
  }

  Replica_hasStateMachine_args args;
  args.read(iprot);
  iprot->readMessageEnd();
  uint32_t bytes = iprot->getTransport()->readEnd();

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postRead(ctx, "Replica.hasStateMachine", bytes);
  }

  Replica_hasStateMachine_result result;
  try {
    result.success = iface_->hasStateMachine(args.name);
    result.__isset.success = true;
  } catch (ReplicaError &e) {
    result.e = e;
    result.__isset.e = true;
    ...
    if (this->eventHandler_.get() != NULL) {
      this->eventHandler_->handlerError(ctx, "Replica.hasStateMachine");
    }

    ::apache::thrift::TApplicationException x(e.what());
    oprot->writeMessageBegin("hasStateMachine", ::apache::thrift::protocol::T_EXCEPTION, seqid);
    x.write(oprot);
    oprot->writeMessageEnd();
    oprot->getTransport()->writeEnd();
    oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preWrite(ctx, "Replica.hasStateMachine");
  }

  oprot->writeMessageBegin("hasStateMachine", ::apache::thrift::protocol::T_REPLY, seqid);
  result.write(oprot);
  oprot->writeMessageEnd();
  bytes = oprot->getTransport()->writeEnd();
  oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postWrite(ctx, "Replica.hasStateMachine", bytes);
  }
}

void ReplicaProcessor::process_replaceRM(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
    ctx = this->eventHandler_->getContext("Replica.replaceRM", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "Replica.replaceRM");

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preRead(ctx, "Replica.replaceRM");
  }

  Replica_replaceRM_args args;
  args.read(iprot);
  iprot->readMessageEnd();
  uint32_t bytes = iprot->getTransport()->readEnd();

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postRead(ctx, "Replica.replaceRM", bytes);
  }

  Replica_replaceRM_result result;
  try {
    iface_->replaceRM(args.name);
  } catch (ReplicaError &e) {
    result.e = e;
    result.__isset.e = true;
  } catch (const std::exception& e) {
    if (this->eventHandler_.get() != NULL) {
      this->eventHandler_->handlerError(ctx, "Replica.replaceRM");
    }

    ::apache::thrift::TApplicationException x(e.what());
    oprot->writeMessageBegin("replaceRM", ::apache::thrift::protocol::T_EXCEPTION, seqid);
    x.write(oprot);
    oprot->writeMessageEnd();
    oprot->getTransport()->writeEnd();
    oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preWrite(ctx, "Replica.replaceRM");
  }

  oprot->writeMessageBegin("replaceRM", ::apache::thrift::protocol::T_REPLY, seqid);
  result.write(oprot);
  oprot->writeMessageEnd();
  bytes = oprot->getTransport()->writeEnd();
  oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postWrite(ctx, "Replica.replaceRM", bytes);
  }
}
