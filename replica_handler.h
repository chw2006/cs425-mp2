...
public:
	...
	virtual void create(const std::string& name, const std::string& initialState, const std::vector<int> & RMs, bool & fromFrontEnd);
	...
	virtual int32_t numMachines(const std::string& name);
